...
public class CommentController {
    ...
    @Operation(summary = "게시물에 투표 등록", description = "게시물에 대한 투표 1개 생성")
...
//        postService.updateVoteComment(request, userDetails.getMember());

        // 로그인 구현 전 개발용
        commentService.updateVoteComment(request, 2);
    ...
    @Operation(summary = "[마이페이지] 내가 작성한 댓글 조회", description = "내가 작성한 댓글 List 조회")
    @ApiResponse(responseCode = "200", description = "SUCCESSED")
